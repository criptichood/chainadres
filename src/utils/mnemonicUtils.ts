...
import { mnemonicNew, mnemonicValidate } from '../ton-crypto/src/mnemonic/mnemonic';

export async function generateValidMnemonic(numberOfWords: number, maxAttempts: number): Promise<string> {
